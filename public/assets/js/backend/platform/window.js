define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'platform/window/index' + location.search,
                    add_url: 'platform/window/add',
                    edit_url: 'platform/window/edit',
                    del_url: 'platform/window/del',
                    multi_url: 'platform/window/multi',
                    import_url: 'platform/window/import',
                    table: 'window',
                }
            });
