define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'platform/language/index' + location.search,
                    add_url: 'platform/language/add',
                    edit_url: 'platform/language/edit',
                    del_url: 'platform/language/del',
                    multi_url: 'platform/language/multi',
                    import_url: 'platform/language/import',
                    table: 'language',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'is_default', title: __('Is_default'), searchList: {"0":__('否'),"1":__('是')}, formatter: Table.api.formatter.flag},
                            ...
                            buttons: [
                                {
                                    ...
                                    confirm: '确认设为默认方案？',
                                    url: 'platform/language/setDefault',
                                    hidden: function(row){
