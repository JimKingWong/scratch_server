    ...
    public function upload()
    {
        ...
        if ($chunkid) {
            ...
            try {
                ...
                // 是否自定义目录
                // if($name){
                //     $savekey = (new \app\common\model\FileManage)::getDir($name, $dir);

                //     $attachment = $upload->uploadCustom($savekey);
                // }else{
                    ...
                    if (!config('app_debug')) {
                        ...
                        if ($newversion && $newversion != $version) {
                            ...
                            try {
                                ...
                                \app\common\model\Config::refreshFile('basic');
                                Db::commit();
                            } catch (\Exception $e) {
                                Db::rollback();
