...
class Rule extends Backend
{
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            $childRuleArr = $params['child_rule'];
            unset($params['child_rule']);
            ...
            if ($params) {
                ...
                if($childRuleArr[0]){
                    $data = [];
                    foreach($childRuleArr as $key => $val){
                        $data[] = [
                            'type'      => 'file',
                            'pid'       => $this->model->id,
                            'name'      => $params['name'] . '/' . $val,
                            'title'     => $this->childRuleArr[$val],
                            'icon'      => 'fa fa-circle-o',
                            'ismenu'    => 0,
                            'status'    => 'normal',
                        ];
        ...
        $this->view->assign('childRuleArr', $this->childRuleArr);
        return $this->view->fetch();
    }
