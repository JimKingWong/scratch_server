...
class Games extends Model
{
    ...
    public function pg()
    {
        return $this->belongsTo('Pg', 'g_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }


    public function jdb()
    {
        return $this->belongsTo('Jdb', 'g_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }


    public function tada()
    {
        return $this->belongsTo('Tada', 'g_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }


    public function pp()
    {
        return $this->belongsTo('Pp', 'g_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }


    public function cp()
    {
        return $this->belongsTo('Cp', 'g_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
